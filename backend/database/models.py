...
class PedidoPlatillo(Base):
    __tablename__ = 'platillosporpedidos'
    id = Column(Integer, primary_key=True)
    id_pedido = Column(Integer, nullable=True)
    id_plato = Column(Integer, nullable=True)
    def __repr__(self):
        return '<PedidoPlatillo %r>' % self.name

class Pedido(Base):
    __tablename__ = 'pedido'
    id = Column(Integer, primary_key=True)
    numero_mesa = Column(Integer, nullable=True)
    id_personal = Column(Integer, nullable=True)
    terminado = Column(Boolean, nullable=True)
    def __repr__(self):
        return '<Pedido %r>' % self.name
