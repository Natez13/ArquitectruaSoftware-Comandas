...
COPY public.platillo (id, precio, nombre) FROM stdin;
\.
...
COPY public.platillosporpedidos (id_pedido, id_plato) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.platillo_id_seq', 1, false);
...
INSERT into public.platillo (nombre,precio) values ('Pollo con Arroz',8990);

-- Insertar Mesas
INSERT into public.mesa values (1,4,true);
INSERT into public.mesa values (2,5,true);
INSERT into public.mesa values (3,5,true);
INSERT into public.mesa values (5,3,true);
INSERT into public.mesa values (6,4,true);

-- Insertar personal
INSERT into public.personal values (1,'Nico');
INSERT into public.personal values (2,'Seba');
INSERT into public.personal values (3,'Fernando');
--
